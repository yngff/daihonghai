<%@ page language="C#" autoeventwireup="true" inherits="admin_Pro_Up, www_deploy" %>
    ...
    <div>
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table align="center" border="1" bordercolordark="#ffffff" bordercolorlight="#6591be" cellpadding="0" cellspacing="0" width="78%">
			...
			<tr>
				<td bgcolor="#ecf5ff" style=" HEIGHT: 14px" align="right"><FONT face="宋体">商品价格：</FONT>
				</td>
				<td width="88%" bgcolor="#ecf5ff" style="HEIGHT: 14px">
					<asp:TextBox id="price" runat="server" Width="83px"></asp:TextBox>
				</td>
			</tr>
            <tr>
			    <td bgcolor="#ecf5ff" align="right"><FONT face="宋体">商品图片：</FONT>
			    </td>
			    <td bgcolor="#ecf5ff" align="Left"><input id="file2" type="file" size="50" name="file2" runat="server">
                  <asp:Button ID="Button2" runat="server" OnClick="Button2_Click" Text="修改图片" />
                    <asp:Label ID="lblfileurl" runat="server" Visible="false"></asp:Label>&nbsp;&nbsp;<a href="../SYImg/<%=picname %>" target="_blank">图片预览</a>
            ...
            <tr>
			    <td bgcolor="#ecf5ff" align="right" style="height: 18px"><FONT face="宋体">是否显示：</FONT>
			    </td>
			    <td bgcolor="#ecf5ff" align="Left" style="height: 18px">
                    <asp:RadioButtonList ID="is_show" runat="server" RepeatDirection="Horizontal">
                        ...
                        <asp:ListItem Selected="True" Value="True">否</asp:ListItem>
                    </asp:RadioButtonList></td>
		    </tr>
            <tr>
			    <td bgcolor="#ecf5ff" align="right" style="height: 18px"><FONT face="宋体">精品：</FONT>
			    </td>
			    <td bgcolor="#ecf5ff" align="Left" style="height: 18px">
		    ...
		    <tr>
				<td bgcolor="#ecf5ff" style=" HEIGHT: 14px" align="right"><FONT face="宋体">商品介绍：</FONT>
				</td>
				<td width="88%" bgcolor="#ecf5ff" style="HEIGHT: 14px"><fckeditorv2:FCKeditor id="txtContent" runat="server" Width="100%" BasePath="../FCKeditor/" Height="400px"></fckeditorv2:FCKeditor>
					</td>
			</tr>
			<tr bgcolor="#ecf5ff">
