<%@ page language="C#" autoeventwireup="true" inherits="manage_AboutUs_Add, www_deploy" %>
    ...
    <div>
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
        ...
        <table align="center" border="1" bordercolordark="#ffffff" bordercolorlight="#6591be"
			...
			<tr>
				<td bgcolor="#ecf5ff" style=" HEIGHT: 14px" align="right"><FONT face="����">��Ŀ���⣺</FONT>
				</td>
			...
			<tr>
				<td bgcolor="#ecf5ff" style=" HEIGHT: 14px" align="right"><FONT face="����">Ӣ�ı��⣺</FONT>
				</td>
				<td width="88%" bgcolor="#ecf5ff" style="HEIGHT: 14px">
            ...
            <tr>
			    <td bgcolor="#ecf5ff" align="right"><FONT face="����">��������</FONT>
			    </td>
			...
			<tr>
				<td bgcolor="#ecf5ff" align="right"><FONT face="����">��Ŀ���ݣ�</FONT>
				</td>
			...
			<tr>
				<td bgcolor="#ecf5ff" align="right"><FONT face="����">Ӣ�����ݣ�</FONT>
				</td>
			...
			<tr bgcolor="#ecf5ff">
				<td height="30" colspan="2">
					<div align="center">&nbsp;&nbsp;&nbsp;
                        ...
                        <input id="Button1" type="button" value="����" onclick="history.go(-1);"/></div>
				</td>
			</tr>
        </table>
    </div>
