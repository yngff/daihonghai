<%@ page language="C#" autoeventwireup="true" inherits="admin_HrAcc_Manage, www_deploy" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="25" align="center" background="images/YX_Bg.jpg">
                    <span class="STYLE1">求 职 信 息 管 理</span></td>
            </tr>
        </table>
				...
				<td>
					<asp:datagrid id="dgHr" DataKeyField="ID" runat="server" Width="100%" AutoGenerateColumns="False"
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="应聘职位">
								<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									&nbsp;<%# DataBinder.Eval(Container.DataItem, "Quarters").ToString()%>
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderText="学历">
								<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									&nbsp;<%# DataBinder.Eval(Container.DataItem, "Studydegree").ToString()%>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="专业">
								...
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									&nbsp;<%# DataBinder.Eval(Container.DataItem, "Specialty").ToString()%>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="联系方式">
								...
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									&nbsp;<%# DataBinder.Eval(Container.DataItem, "Phone").ToString()%>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="应聘时间">
								<HeaderStyle HorizontalAlign="Center"></HeaderStyle>
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									&nbsp;<%# DataBinder.Eval(Container.DataItem,"AddDate").ToString()%>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="操作">
								...
								<ItemTemplate>
									<asp:LinkButton ID="lbtnUp" Runat="server" CommandName="Up">详细信息</asp:LinkButton>
								</ItemTemplate>
							</asp:TemplateColumn>
						</Columns>
