<%@ page language="C#" autoeventwireup="true" inherits="admin_News_Manage, www_deploy" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="25" align="center" background="images/YX_Bg.jpg">
                    <span class="STYLE1">新 闻 信 息 管 理</span></td>
            </tr>
        </table>
					...
					<asp:datagrid id="dgMenu" DataKeyField="ID" runat="server" Width="100%" AutoGenerateColumns="False"
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="状态">
								...
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
										<%#(DataBinder.Eval(Container.DataItem,"is_top").ToString()=="False")?"正常":"<font color=#ff0000>视频新闻</font>"%>
									<asp:LinkButton ID="lbtnShow" Runat="server" CommandName="is_show">
										<%#(DataBinder.Eval(Container.DataItem,"is_show").ToString()=="False")?"发布":"<font color=#ff0000>隐藏</font>"%>
									</asp:LinkButton>
								</ItemTemplate>
							</asp:TemplateColumn>
