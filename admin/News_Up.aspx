<%@ page language="C#" autoeventwireup="true" inherits="admin_News_Up, www_deploy" %>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="25" align="center" background="images/YX_Bg.jpg">
                    <span class="STYLE1">修 改 新 闻</span></td>
            </tr>
        </table>
        ...
        <table align="center" border="1" bordercolordark="#ffffff" bordercolorlight="#6591be" cellpadding="0" cellspacing="0" width="88%">
            ...
            <tr>
			    <td bgcolor="#ecf5ff" align="right" style="height: 18px"><FONT face="宋体">作者：</FONT>
			    </td>
			    <td bgcolor="#ecf5ff" align="Left" style="height: 18px"><asp:TextBox ID="author" runat="server">管理员</asp:TextBox></td>
		    </tr>
            <tr>
