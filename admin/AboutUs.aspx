<%@ page language="C#" autoeventwireup="true" inherits="manage_AboutUs_Manage, www_deploy" %>
        ...
        <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
					...
					<asp:datagrid id="dgMenu" DataKeyField="ID" runat="server" Width="100%" AutoGenerateColumns="False"
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="����">
								...
								<ItemTemplate>
									<asp:LinkButton ID="lbtnUp" Runat="server" CommandName="Up">��ϸ</asp:LinkButton>
									<asp:LinkButton ID="lbtnDel" Runat="server" CommandName="Del">ɾ��</asp:LinkButton>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:EditCommandColumn ButtonType="LinkButton" UpdateText="����" HeaderText="����" CancelText="ȡ��" EditText="�޸�" CausesValidation="false">
		                        <HeaderStyle HorizontalAlign="Center"></HeaderStyle>
		                        <ItemStyle HorizontalAlign="Center"></ItemStyle>
			...
			<tr>
				<td><table width="100%" class="table_southidc" cellpadding="0" cellspacing="0">
						<tr>
							<td class="back_southidc" width="229" height="20" align="left"><FONT face="����"><input name="chkAll" type="checkbox" id="chkAll" onclick="CheckAll(this.form)" value="checkbox">ȫѡ&nbsp;&nbsp;
									<asp:Button id="btnDel" runat="server" Width="104px" Text="ɾ��ѡ����" CausesValidation="False" onclick="btnDel_Click"></asp:Button></FONT></td>
