<%@ page language="C#" autoeventwireup="true" inherits="admin_Culture_Add, www_deploy" %>
     ...
     <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="25" align="center" background="images/YX_Bg.jpg">
                    <span class="STYLE1"> 企 业 文 化 添 加</span></td>
            </tr>
        </table>
        ...
        <table align="center" border="1" bordercolordark="#ffffff" bordercolorlight="#6591be"
            ...
            <tr>
			    <td bgcolor="#ecf5ff" align="right"><FONT face="宋体">排序：</FONT>
			    </td>
