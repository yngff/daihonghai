<%@ page language="C#" autoeventwireup="true" inherits="admin_Pro_Manage, www_deploy" %>
        ...
        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td height="25" align="center" background="images/YX_Bg.jpg">
                    <span class="STYLE1">商 品 信 息 管 理</span></td>
            </tr>
        </table>
					...
					<asp:datagrid id="dgMenu" DataKeyField="ID" runat="server" Width="100%" AutoGenerateColumns="False"
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="状态">
								...
								<ItemStyle HorizontalAlign="Center"></ItemStyle>
								<ItemTemplate>
									<asp:LinkButton ID="lbtnTop" Runat="server" CommandName="is_top">
										<%#(DataBinder.Eval(Container.DataItem,"is_top").ToString()=="False")?"正常":"<font color=#ff0000>精品</font>"%>
									</asp:LinkButton>
									<asp:LinkButton ID="lbtnShow" Runat="server" CommandName="is_show">
										<%#(DataBinder.Eval(Container.DataItem,"is_show").ToString()=="False")?"显示":"<font color=#ff0000>隐藏</font>"%>
									</asp:LinkButton>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="管理">
								...
								<ItemTemplate>
								    <%--<asp:LinkButton ID="lbtnPic" Runat="server" CommandName="PicManage">图片管理</asp:LinkButton>--%>
