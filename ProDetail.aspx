<%@ page language="C#" autoeventwireup="true" inherits="ProDetail, www_deploy" %>
    ...
    <tr>
     <td height="328" valign="top" bgcolor="#FFFFFF"><table width="865" border="0" align="center" cellpadding="0" cellspacing="0">
       <tr>
         ...
         <td width="633" height="40" valign="top"><table border="0" cellpadding="0" cellspacing="0" height="35" width="200">
                 <tr>
                     <td align="center" width="30">
                         <img height="5" src="images/index1_02.gif" width="4" /></td>
                     <td width="170">
                         <a href="Default.aspx">首页</a> &gt; <a href="ProShow.aspx">产品中心</a> &gt;
       ...
       <tr>
         <td valign="top">
         <table width="631" height="566" border="0" cellpadding="0" cellspacing="1" bgcolor="#e7e7e7">
           <tr>
             <td valign="top" bgcolor="#FFFFFF" class="nav_pic"><br />
               <br />
               <br />
               <table border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                   <td class="container_font_01"><asp:Label runat="server" ID="k_title"></asp:Label></td>
                 </tr>
               </table>
               ...
               <table border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                   <td><img src="SYImg/<%=picurl %>" /></td>
                 </tr>
               </table>
               <br />
               <table width="573" border="0" align="center" cellpadding="0" cellspacing="0" style="line-height:20px;" class="sidebar_font_04">
                 <tr>
                   <td valign="top" height="20" width="60">
                       产品价格：</td>
                   <td valign="top"><asp:Label ID="k_price" runat="server"></asp:Label></td>
                 </tr>
                 <tr>
                   <td valign="top" height="20">
                       浏览次数：</td>
                   <td valign="top"><asp:Label ID="k_hits" runat="server"></asp:Label></td>
                 </tr>
                 <tr>
                   <td valign="top">
                       产品介绍：</td>
                   <td valign="top"><asp:Label runat="server" ID="k_content"></asp:Label></td>
                 </tr>
               </table></td>
           </tr>
         </table>
