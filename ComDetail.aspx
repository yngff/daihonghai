<%@ page language="C#" autoeventwireup="true" inherits="ComDetail, www_deploy" %>
               ...
               <table width="573" border="0" align="center" cellpadding="0" cellspacing="0">                 
                 <tr>
                     <td colspan="2" align="left" valign="top">
                         <asp:Label runat="server" ID="k_content"></asp:Label></td>
                 </tr>
               </table>
               <br />
               <table width="573" border="0" align="center" cellpadding="0" cellspacing="0" style="line-height:20px;" class="sidebar_font_04">
                 <tr>
                   <td valign="top" height="20" width="60">公司网站：</td>
                   <td valign="top"><asp:Label ID="k_url" runat="server"></asp:Label></td>
                 </tr>
                 <tr>
                   <td valign="top" height="20">营业范围：</td>
                   <td valign="top"><asp:Label ID="k_fanwei" runat="server"></asp:Label></td>
                 </tr>
                 <tr>
                   <td valign="top" height="20">公司地址：</td>
                   <td valign="top"><asp:Label ID="k_address" runat="server"></asp:Label></td>
                 </tr>
               </table></td>
           </tr>
         </table>
