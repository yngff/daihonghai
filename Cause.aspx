<%@ page language="C#" autoeventwireup="true" inherits="Cause, www_deploy" %>
       ...
       <tr>
             ...
             <td width="239" valign="top" bgcolor="#f8f8f8"><br />
               <table width="191" border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                   ...
                   <td width="163" class="sidebar_font_01">光彩事业</td>
                 </tr>
               </table>
         ...
         <td width="633" height="40" valign="top"><table height="35" border="0" cellpadding="0" cellspacing="0">
           <tr>
             ...
             <td><a href="Default.aspx">首页</a> &gt; <a href="Cause.aspx">光彩事业</a>&nbsp;&gt;&nbsp;<asp:Label runat="server" ID="classname"></asp:Label></td>
           </tr>
         </table></td>
       </tr>
       <tr>
           ...
           <tr>
             <td valign="top" bgcolor="#FFFFFF" class="nav_pic"><div>
                 ...
                 <asp:Repeater runat="server" ID="rtNews">
                       <ItemTemplate>
                           <li><a href="CauseDetail.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>"><%# DataBinder.Eval(Container.DataItem, "title")%></a></li>
                       </ItemTemplate>
                   </asp:Repeater>
                 </ul>
             </div>
               <table height="29" border="0" align="center" cellpadding="0" cellspacing="0" class="sidebar_font_03">
                 <tr>
                   ...
                   <td><webdiyer:aspnetpager id="Page1" runat="server" PageSize="15" AlwaysShow="True" OnPageChanged="Page1_PageChanged" NumericButtonTextFormatString="[{0}]&nbsp;" PagingButtonSpacing="3px"></webdiyer:aspnetpager></td>
                 </tr>
               </table></td>
           </tr>
         </table></td>
