<%@ page language="C#" autoeventwireup="true" inherits="NewsDetail, www_deploy" %>
       ...
       <tr>
         ...
         <td width="633" height="40" valign="top"><table width="200" height="35" border="0" cellpadding="0" cellspacing="0">
           <tr>
             ...
             <td width="170"><a href="Default.aspx">首页</a> &gt; <a href="News.aspx">新闻动态</a>&nbsp;&gt;&nbsp;<asp:Label runat="server" ID="classname"></asp:Label></td>
           </tr>
         </table></td>
       </tr>
       <tr>
         ...
         <table width="631" height="566" border="0" cellpadding="0" cellspacing="1" bgcolor="#e7e7e7">
           <tr>
             <td valign="top" bgcolor="#FFFFFF" class="container_bj"><br />
               ...
               <table border="0" align="center" cellpadding="0" cellspacing="0">
                 <tr>
                   <td class="column_font_03">作者：<asp:Label runat="server" ID="n_author"></asp:Label>&nbsp;&nbsp;发布时间：<asp:Label runat="server" ID="n_updatetime"></asp:Label>&nbsp;&nbsp;点击次数：<asp:Label runat="server" ID="n_hits"></asp:Label> </td>
                 </tr>
               </table>
               <br />
               <br />
