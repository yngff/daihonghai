<%@ page language="C#" autoeventwireup="true" inherits="Media, www_deploy" %>
       ...
       <tr>
         ...
         <td width="633" height="40" valign="top"><table height="35" border="0" cellpadding="0" cellspacing="0">
           <tr>
             ...
             <td><a href="Default.aspx">首页</a> &gt; <a href="About.aspx">个人网站</a> &gt; 媒体报道&nbsp;
             </td>
           </tr>
         </table></td>
       </tr>
           ...
           <tr>
             <td valign="top" bgcolor="#FFFFFF" class="nav_pic"><div>
                 ...
                 <asp:Repeater runat="server" ID="rtNews">
                       <ItemTemplate>
                           <li><a href="MediaDetail.aspx?id=<%# DataBinder.Eval(Container.DataItem, "id")%>"><%# DataBinder.Eval(Container.DataItem, "title")%></a></li>
                       </ItemTemplate>
                   </asp:Repeater>
                 </ul>
             </div>
