<%@ page language="C#" autoeventwireup="true" inherits="CultureD, www_deploy" %>
       ...
       <tr>
         ...
         <td width="633" height="40" valign="top"><table width="200" height="35" border="0" cellpadding="0" cellspacing="0">
           <tr>
             ...
             <td width="170"><a href="Default.aspx">首页</a> &gt; <a href="Culture.aspx">龙兴活动</a>&nbsp;&gt;&nbsp;<asp:Label runat="server" ID="classname"></asp:Label></td>
           </tr>
         </table></td>
       </tr>
       <tr>
